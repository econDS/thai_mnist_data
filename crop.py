...
def write_img(filename, folder_out):
    ...
    for num, grid in enumerate(allgrid):
        savename = "./extract/"+folder_out+'/'+filename.split(".")[0]+str(num+1)+'.jpg'
        print(savename)
        cv2.imwrite(savename, grid)
        

aum_folder = "อั้ม/handwriting_aumm_v2"
aumf_folder = "อั้ม/handwriting_aumm_font_jpeg"

aum_folder = "โบ้/พยัญชนะ_n"
bo2 = "โบ้/สระ_n_edit"

pap_folder = "แปป/Thai Handwriting thana" # 44
papf_folder = ""
